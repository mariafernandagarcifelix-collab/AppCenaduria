...
public partial class VerMenuMesero : ContentPage
{
    ...
    {
        // NO animamos el botón aquí porque ya está siendo animado en un bucle infinito.

        // 🔥 REDIRIGIMOS AL CARRITO FLOTANTE SEGÚN EL ROL
        if (App.UsuarioActual != null && App.UsuarioActual.Rol == "Mesero")
        {
            await Navigation.PushAsync(new ComandaMesero());
        }
        else
        {
